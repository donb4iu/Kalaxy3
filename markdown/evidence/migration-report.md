...
|---|---|---|---|---|
| [End-to-End Thin Slice](../architecture/kalaxy3-sage-thin-slice.md) | legacy-evidence | inferred | not-started | Curate title, summary, dates, and ownership |
...
- CURATION: markdown/architecture/kalaxy3-sage-thin-slice.md needs registry review
...
- LEGACY: markdown/architecture/kalaxy3-sage-thin-slice.md indexed as legacy-evidence with inferred metadata
