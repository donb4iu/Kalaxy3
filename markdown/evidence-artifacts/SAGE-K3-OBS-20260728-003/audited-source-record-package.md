...
The publisher replaces `__SAGE_IMPLEMENTATION_COMMIT__` with `4247387a8062a0a353f5704e40c90b1727881a4a`, replaces `__SAGE_PUBLISHED_AT__`, creates the record checksum and publication manifest, reconciles evidence indexes, commits the evidence, and pushes the branch.
